...
export const products: Product[] = [
  ...
  },
  {
    ...
    specs: {
      Model: "HS-43",
      Battery: "40,000 mAh, rechargeable lithium polymer, 148Wh",
      ...
      "Built-in Micro-USB Cable": "5V/2.1A",
      "USB-C Input": "PD 18W max",
      "USB-A Input Cable": "QC 18W max",
      "Charging Time": "Approx. 6 hours with PD20W charger",
      "Hand-Crank Speed": "120-180 rpm",
