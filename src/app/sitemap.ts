...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${SITE_URL}/portable-power`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${SITE_URL}/home-resilience`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.8 },
    ...
    { url: `${SITE_URL}/case-studies`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.6 },
    { url: `${SITE_URL}/partners/ecoflow/delta-pro-ultra`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.7 },
